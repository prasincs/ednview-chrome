h2. EDNView for Chrome


This was done as a quick hack to view edn in browser. YMMV. The rest of the text from the original text has been left intact.
...
h2. Text from jsonview-chrome project 
